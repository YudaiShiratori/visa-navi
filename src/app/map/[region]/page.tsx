...
import { regionDescriptions, regionNames } from "../../../constants/regions";
  ...
  return (
    <div className="py-8 md:py-12">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="mb-8">
          <h1 className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-center font-bold text-3xl text-transparent md:text-4xl">
            {regionName}のビザ情報
          </h1>
                  ...
                  <div className="mt-auto flex flex-col gap-2">
                    ...
                    {country.visaRequirement.duration && (
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-gray-500 text-xs">日間</span>
                      </div>
                    )}
                  </div>
                </div>
