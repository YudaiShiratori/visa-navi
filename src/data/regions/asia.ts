...
export const asiaCountries: Country[] = [
  ...
  },
  {
    ...
    conditions: [
      ...
      "【K-ETA一時免除措置】2025年12月31日まで日本を含む22か国・地域のパスポートを持つ外国人が観光・短期商用等の目的で無査証で入国する場合は、K-ETAを取得すること無く入国可能",
      "90日以内の滞在でも就業、営利活動目的（機械の据付等の技術目的等）、家族帯同等の場合はビザ取得が必要",
    ],
    notes: [
      "K-ETA一時免除措置は2026年12月末まで延長される方針（正式決定は要確認）",
  ...
  },
  {
    ...
    notes: [
      "2023年10月1日より日本を含む7か国向けに無料30日ビザ免除パイロット施策が開始され、2025年9月現在も「当面の間（until further notice）」継続中。終了日は未定のため、渡航前に在東京スリランカ大使館または入国管理局サイトで要確認。",
