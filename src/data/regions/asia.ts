...
export const asiaCountries: Country[] = [
  ...
  },
  {
    ...
    notes: [
      "2023年10月1日より日本を含む複数国向けに無料30日ETA（電子渡航認証）施策が開始され、2026年1月現在も「当面の間（until further notice）」継続中。対象国は段階的に拡大され39か国に。終了日は未定のため、渡航前に在東京スリランカ大使館または入国管理局サイトで要確認。",
      "観光・ビジネス目的の短期滞在にはオンラインでeTAを取得可能（現在は申請料無料）",
      "東京の大使館でもビザ申請可能",
