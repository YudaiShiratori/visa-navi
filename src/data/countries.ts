...
export const countries: Country[] = [
  {
    ...
    notes: ["30日を超える滞在にはビザの取得が必要", "e-VISAも利用可能"],
    officialLinks: {
  ...
  },
  {
    ...
    conditions: ["パスポートの残存有効期間が6ヶ月以上必要"],
    notes: ["K-ETAの事前取得が必要", "東京・横浜・名古屋・大阪・福岡の領事館でビザ申請も可能"],
    lastUpdated: "2024-05-21",
  },
  {
    id: "china",
    ...
    conditions: ["パスポートの残存有効期間が6ヶ月以上必要"],
    notes: ["大使館、名古屋・大阪・福岡・新潟の領事館でビザ申請可能", "外国籍者向けビザも発行"],
    lastUpdated: "2024-05-21",
  },
  {
    id: "taiwan",
  ...
  },
  {
    ...
    conditions: ["パスポートの残存有効期間が6ヶ月以上必要"],
    notes: ["e-Visaの利用が可能", "東京・大阪の窓口でビザ申請も可能"],
    lastUpdated: "2024-05-21",
  },
  {
    id: "cambodia",
  ...
  },
  {
    ...
    conditions: ["パスポートの残存有効期間が6ヶ月以上必要"],
    notes: ["e-VISAの利用が可能", "大使館でのビザ申請も可能"],
    lastUpdated: "2024-05-21",
  },
  {
    id: "mongolia",
  ...
  },
  {
    ...
    conditions: ["パスポートの残存有効期間が1ヶ月以上必要"],
    lastUpdated: "2024-05-21",
  },
  {
    id: "brunei",
