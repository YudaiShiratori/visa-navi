...
export function MapSelector() {
  ...
  return (
    <div className="space-y-8">
      <div className="relative h-[500px] w-full max-w-3xl mx-auto overflow-hidden rounded-2xl bg-blue-50 shadow-lg">
        <div className="relative h-full w-full">
          ...
          {activeRegion ? <div
              ...
              style={{
                ...
                backgroundColor: regionColors[activeRegion].light,
                border: `2px solid ${regionColors[activeRegion].main}`,
                borderRadius: '12px',
                boxShadow: `0 0 20px ${regionColors[activeRegion].hover}30`,
